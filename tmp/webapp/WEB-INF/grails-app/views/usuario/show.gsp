            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.deseos.label" default="Deseos" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${usuarioInstance.deseos}" var="d">
                                    <li><g:link controller="deseo" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.fechaAlta.label" default="Fecha Alta" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${usuarioInstance?.fechaAlta}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.tipoUsuario.label" default="Tipo Usuario" /></td>
                            
                            <td valign="top" class="value">${usuarioInstance?.tipoUsuario?.encodeAsHTML()}</td>
