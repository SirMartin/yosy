			...
			<div class="dialog">
				<table>
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="deseos"><g:message
										code="usuario.deseos.label" default="Deseos" /></label></td>
							<td valign="top"
								class="value ${hasErrors(bean: usuarioInstance, field: 'deseos', 'errors')}">
								<g:select name="deseos" from="${org.domain.Deseo.list()}"
									multiple="yes" optionKey="id" size="5"
									value="${usuarioInstance?.deseos*.id}" />
							</td>
						</tr>
						...
						<tr class="prop">
							<td valign="top" class="name"><label for="fechaAlta"><g:message
										code="usuario.fechaAlta.label" default="Fecha Alta" /></label></td>
							<td valign="top"
								class="value ${hasErrors(bean: usuarioInstance, field: 'fechaAlta', 'errors')}">
								<g:datePicker name="fechaAlta" precision="day"
									value="${usuarioInstance?.fechaAlta}" />
							</td>
						</tr>
